...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference("Reaction.count") do
      post reactions_url, params: { reaction: { comment_id: @reaction.comment_id, kind: @reaction.kind } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { comment_id: @reaction.comment_id, kind: @reaction.kind } }
